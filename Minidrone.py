...
class MamboGroundcam:
    def __init__(self):
        ...
        try:
            self.ftp = FTP('192.168.99.32')  # IP-Address of the drone itself
...
class Minidrone:
    def __init__(self, address="", use_wifi=False, wifi_ip="192.168.99.32"):
        """
    ...
    def connect(self, num_retries):
        ...
        connected = self.drone_connection.connect(num_retries, self.wifi_ip)
        return connected
