...
class Player(QMainWindow):
    ...
    def __init__(self, vlc_player, drone_gui):
        ...
        self.setWindowTitle("VLC Drone Video Player"+str(self))
...
class DroneVisionGUI:
    def __init__(self, drone_object, is_bebop, user_code_to_run, user_args, buffer_size=200, network_caching=200, fps=20, user_draw_window_fn=None, wifi_ip="192.168.99.32"):
        """
    ...
    def open_video(self):
        ...
        print(shortPathIndex)
        shortPath = fullPath[0:shortPathIndex]
        if self.wifi_ip=="192.168.99.32":
            self.imagePath = join(shortPath, "images 1")
        else:
            self.imagePath = join(shortPath, "images 2")
